...
public class UILocalize : MonoBehaviour
{
	...
	public enum CaseType { NoChange, FullUpper, FullLower, FirstUpper }
	public CaseType caseType = CaseType.NoChange;
...
//					sp.MakePixelPerfect();
	...
	string SetCase(string value)
	{
		switch (caseType)
		{
		case CaseType.FullUpper:
			return value.ToUpper();
		case CaseType.FullLower:
			return value.ToLower();
		// TODO
		case CaseType.FirstUpper:
			return value;
		case CaseType.NoChange:
		default:
			return value;
		}
	}
