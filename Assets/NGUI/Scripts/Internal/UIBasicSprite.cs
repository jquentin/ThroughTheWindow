...
public abstract class UIBasicSprite : UIWidget
{
	...
	[HideInInspector][SerializeField] protected bool mOverridePixelSize = false;
	[HideInInspector][SerializeField] protected float mPixelSize = 1f;
