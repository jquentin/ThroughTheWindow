...
public class UIBasicSpriteEditor : UIWidgetInspector
{
	...
	protected override void DrawCustomProperties ()
	{
		...
		SerializedProperty spOPS = NGUIEditorTools.DrawProperty("Override Pixel Size", serializedObject, "mOverridePixelSize", GUILayout.MinWidth(100f));

		bool overridePixelSize = spOPS.boolValue;
