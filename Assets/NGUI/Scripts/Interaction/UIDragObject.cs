...
public class UIDragObject : MonoBehaviour
{
	...
	{
//		if(ModeSelectionScreen.instance.IsActive)
//			return;
	
		//////////////////////////////////////////////////////////
		// Tiggly Custom code used for Pause Menu dragging
		// Cancels any dragging movement if beyond boundaries
		if(stopDrag)
		{
			UICamera.currentTouch.dragged = null;
			UICamera.currentTouch.pressed = null;
			
			//mLastPos = new Vector3(1.2f, 24.9f, 0);
			stopDrag = false;
			noOffset = true;
			return;
		}
		...
		if (mPressed && mTouchID == UICamera.currentTouchID && enabled && NGUITools.GetActive(gameObject) && target != null)
		{
			...
			///////////////////////////////////////////////
			// Tiggly Custom code
//			if(PauseMenu.instance.m_eCurrentState != PauseMenu.STATE.DRAGGING)
//			{
//				PauseMenu.instance.SetState(PauseMenu.STATE.DRAGGING);
